...
const update = (e) => {
    ...
    Promise.resolve(axios.post(`/api/posts/${props.post.id}`, formData))
    .then((value) => {
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-col gap-y-4">
                    ...
                    <div class="flex w-full justify-start items-center">
                        <Link class="rounded px-4 py-2 bg-blue-500 hover:bg-blue-600 w-fit text-white" href="/tiny-results">Back</Link>
                    </div>
                    ...
                    <div class="flex justify-end items-center mt-4 w-full">
                        <PrimaryButton class="ml-4" @click="update">
                            Update
                        </PrimaryButton>
                    </div>
